...
def affine_batchnorm_relu_backward(dout, cache):
  ...
  dout, d_gamma, d_beta = batchnorm_backward(dout, batchnorm_cache)
  dx, dw, db = affine_backward(dout, fc_cache)
  return dx, dw, db, d_gamma, d_beta

def affine_layernorm_relu_forward(x, w, b, gamma, beta, bn_param ):
  out, fc_cache = affine_forward(x, w, b)
  out ,batchnorm_cache = layernorm_forward(out, gamma, beta, bn_param)
  out, relu_cache = relu_forward(out)
  cache = (fc_cache, batchnorm_cache, relu_cache)
  return out, cache
...
def affine_layernorm_relu_backward(dout, cache):
  fc_cache, batchnorm_cache, relu_cache = cache
  dout = relu_backward(dout, relu_cache)
  dout, d_gamma, d_beta = layernorm_backward(dout, batchnorm_cache)
  dx, dw, db = affine_backward(dout, fc_cache)
  return dx, dw, db, d_gamma, d_beta
